...
rule all_qc_multiqc_report:
    ...
    output:
        report_dir = "../F.report/Data_QC_report/Data_QC_report.html"
    conda:
        "../envs/multiqc.yaml",
    message:
...
rule mapping_qc_multiqc_report:
    ...
    output:
        report_dir = "../F.report/Mapping_QC_report/Mapping_QC_report.html",
    conda:
        "../envs/multiqc.yaml",
    message:
...
rule variant_stats_multiqc_report:
    ...
    output:
        report_dir = "../F.report/Mapping_QC_report/Variant_Stats_report.html",
    conda:
        "../envs/multiqc.yaml",
    message:
